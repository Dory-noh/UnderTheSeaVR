...
public class Fish : MonoBehaviour
{
    ...
    public bool IsBumped { get { return isBumped; } set { isBumped = value; } }
    /// <summary>
    /// 수조의 중심 위치.  
    /// 장애물 회피 시 기준점으로 사용됨.
    /// </summary>
    ...
    /// 물고기의 최대 이동 속도 (m/s).
    /// </summary>
    public float swimSpeedMax = 8.0f;
    ...
    private void Update()
    {
        ...
        {
            //게임 오버시 UI막지 않도록 하기 위해 콜라이더 disable설정함.
    ...
    void TracePlayer()
    {
        ...
        if (distanceToPlayer < playerSensingDistance)
        {
            ...
            UIManagerForGameScene.Instance.dangerAlertSFX?.Invoke();
